...
- JDK - чрез него програмистите могат създават нови Java програми, които да бъдат
изпълнявани от JRE и JVM

- JRE - съвкупността от библиотеки които ще се използват по време на изпълнение на
програмта заедно с нещото което изпълнява програмата
...
Не е задължително на един компюътр да има инсталиран `JDK` за да може да изпълни една Java програма.
