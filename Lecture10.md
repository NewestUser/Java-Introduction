...
Наследяването и композицията са два от основните начини по, които могат да бъдат изградени тези връзки.
И двата подхода целят да предоставят механизъм за преизползване на функционалност (код).

Можем да кажем използваме наследяване, когато един клас наследява друг клас за да презиползва неговата функционалност.
...
Това е конвенция, която препоръчва стойности, с неясен прозиход и значение, записани (hardcoded) в кода 
